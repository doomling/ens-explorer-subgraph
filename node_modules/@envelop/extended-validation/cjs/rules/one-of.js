    ...
    return {
        Field: node => {
            if (node.arguments?.length) {
                ...
                const isOneOfFieldType = fieldType.extensions?.oneOf || (fieldType.astNode && (0, common_js_1.getDirectiveFromAstNode)(fieldType.astNode, 'oneOf'));
...
function traverseVariables(validationContext, arg, graphqlType, currentValue) {
    ...
    const isOneOfInputType = inputType.extensions?.oneOf || (inputType.astNode && (0, common_js_1.getDirectiveFromAstNode)(inputType.astNode, 'oneOf'));
