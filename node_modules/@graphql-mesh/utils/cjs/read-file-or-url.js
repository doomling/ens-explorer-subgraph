    ...
    return js_yaml_1.DEFAULT_SCHEMA.extend([
        new js_yaml_1.Type('!include', {
            ...
            construct(path) {
                ...
                const absoluteFilePath = cross_helpers_1.path.isAbsolute(path) ? path : cross_helpers_1.path.resolve(newCwd, path);
        ...
        new js_yaml_1.Type('!includes', {
            ...
            construct(path) {
                const newCwd = cross_helpers_1.path.dirname(filepath);
                const absoluteDirPath = cross_helpers_1.path.isAbsolute(path) ? path : cross_helpers_1.path.resolve(newCwd, path);
